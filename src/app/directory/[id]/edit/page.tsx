        ...
        <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-zinc-950 pb-24">
            ...
            <div className="bg-surface-light dark:bg-surface-dark px-6 pt-8 pb-6 rounded-b-[2rem] shadow-sm">
                <div className="flex items-center gap-4">
                    <button onClick={() => router.back()} className="text-text-main dark:text-text-main-dark p-1 rounded-full hover:bg-background-light dark:hover:bg-background-dark transition-colors flex items-center justify-center">
