    ...
    return (
        <main className="min-h-screen bg-slate-50 dark:bg-[#0F0F10] pb-32">
            ...
            <header className="sticky top-0 z-30 flex items-center gap-3 bg-white/80 dark:bg-[#0F0F10]/80 backdrop-blur-md border-b border-slate-100 dark:border-white/[0.03] px-4 pt-3 pb-3">
                ...
                <div>
                    <p className="text-lg font-black leading-tight tracking-tight text-moriones-red pl-1">🏘️ My Barangay</p>
                    <p className="text-[10px] text-slate-400 dark:text-white/30 font-black uppercase tracking-[0.15em] pl-1">Community tools for Marinduque locals</p>
                </div>
            </header>
            {/* Gradient hero */}
