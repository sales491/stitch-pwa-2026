    ...
    <>
      <div className="relative flex h-full min-h-screen w-full max-w-md flex-col overflow-x-hidden bg-background-light dark:bg-background-dark shadow-2xl">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between bg-surface-light dark:bg-surface-dark px-4 py-3 shadow-sm">
          <button className="flex h-10 w-10 items-center justify-center rounded-full text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">
        ...
        <div className="px-4 pt-6 pb-2">
          ...
          <div className="relative">
            ...
            <input className="block w-full rounded-xl border-none bg-white dark:bg-surface-dark py-3 pl-10 pr-3 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:ring-2 focus:ring-primary dark:text-white dark:focus:ring-primary/60" placeholder="Search for topics or questions..." type="text" />
          </div>
        </div>
        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto px-4 pb-24 pt-4 no-scrollbar">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="flex flex-col items-center justify-center gap-2 rounded-xl bg-white dark:bg-surface-dark p-4 shadow-sm transition active:scale-95">
          ...
          <div className="mb-4 overflow-hidden rounded-xl bg-white dark:bg-surface-dark shadow-sm">
          ...
          {/* Accordion Section: Safety Tips */}
          <div className="mb-6 overflow-hidden rounded-xl bg-white dark:bg-surface-dark shadow-sm">
            <div className="border-b border-slate-100 dark:border-slate-800 px-4 py-4">
              <h3 className="flex items-center gap-2 text-base font-bold text-slate-900 dark:text-white">
          ...
          <div className="px-2 pb-6">
            <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 font-bold text-slate-900 transition hover:bg-primary-dark hover:text-white active:scale-95">
