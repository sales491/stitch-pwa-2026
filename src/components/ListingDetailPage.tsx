    ...
    return (
        <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-900 pb-4">
            ...
            <header className="sticky top-0 z-20 flex items-center justify-between px-4 py-3 bg-white/90 dark:bg-zinc-900/90 backdrop-blur border-b border-slate-100 dark:border-zinc-800">
                <Link href="/marinduque-classifieds-marketplace" className="flex items-center gap-1 text-slate-600 dark:text-slate-300 hover:text-primary transition-colors">
            ...
            <div className="px-4 pt-4 flex flex-col gap-4">
                ...
                <div>
                    <div className="flex items-start justify-between gap-2 mb-1">
                        <h1 className="text-xl font-bold text-slate-900 dark:text-white leading-tight flex-1">
                            {listing.title}
                        </h1>
                ...
                <div className="grid grid-cols-2 gap-2">
                    <a
                        ...
                        className="flex items-center justify-center gap-2 bg-primary text-slate-900 font-bold py-3 rounded-xl transition-all active:scale-95 hover:bg-yellow-400 shadow-sm shadow-primary/30"
                    >
                ...
                <div className="bg-slate-50 dark:bg-zinc-800 rounded-xl p-4">
                    <h2 className="text-sm font-bold text-slate-900 dark:text-white mb-2">Description</h2>
                ...
                <div className="bg-slate-50 dark:bg-zinc-800 rounded-xl p-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="font-semibold text-slate-900 dark:text-white text-sm">{listing.seller.name}</p>
                            <p className="text-xs text-slate-500 dark:text-slate-400">Member since {listing.seller.memberSince}</p>
            ...
            {messageOpen && (
                <div className="fixed inset-0 z-50 flex items-end bg-black/50" onClick={() => setMessageOpen(false)}>
                    ...
                    >
                        ...
                        />
                        <button className="w-full mt-3 bg-primary text-slate-900 font-bold py-3 rounded-xl active:scale-95 transition-all">
                            Send Message
                        </button>
                    </div>
                </div>
